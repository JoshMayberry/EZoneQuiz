...
public class QuizActivity extends AppCompatActivity {
    ...
    private void generateQuestions() {
        ...
        mQuestions.add(new Question(this)
                ...
                .setTypeSingle(R.string.quiz1_1, new int[]{R.string.quiz1_1_a1, R.string.quiz1_1_a2}, 0)
                .setMessageCorrect(R.string.quiz1_1_correct)
                .setMessageIncorrect(R.string.quiz1_1_incorrect)
        );
        mQuestions.add(new Question(this)
                .setImage(R.drawable.quiz1_2)
                .setTypeSingle(R.string.quiz1_2, new int[]{R.string.quiz1_2_a1, R.string.quiz1_2_a2}, 1)
                .setMessageCorrect(R.string.quiz1_2_correct)
                .setMessageIncorrect(R.string.quiz1_2_incorrect)
        );
        mQuestions.add(new Question(this)
                .setImage(R.drawable.quiz1_3)
                .setTypeSingle(R.string.quiz1_3, new int[]{R.string.quiz1_3_a1, R.string.quiz1_3_a2}, 1)
                .setMessageCorrect(R.string.quiz1_3_correct)
                .setMessageIncorrect(R.string.quiz1_3_incorrect)
        );
        mQuestions.add(new Question(this)
                .setImage(R.drawable.quiz2_1)
                .setTypeMultiple(R.string.quiz2_1, new int[]{R.string.quiz2_1_a1, R.string.quiz2_1_a2, R.string.quiz2_1_a3, R.string.quiz2_1_a4}, new int[]{0, 1, 2, 3})
                .setMessageCorrect(R.string.quiz2_1_correct)
                .setMessageIncorrect(R.string.quiz2_1_incorrect)
        );
        mQuestions.add(new Question(this)
                .setImage(R.drawable.quiz3_1)
                .setTypeInteger(R.string.quiz3_1, 1, 6, 2)
                .setMessageCorrect(R.string.quiz3_1_correct)
                .setMessageIncorrect(R.string.quiz3_1_incorrect)
        );
        mQuestions.add(new Question(this)
                .setImage(R.drawable.quiz3_2)
                .setTypeInteger(R.string.quiz3_2, 1, 12, 3)
                .setMessageCorrect(R.string.quiz3_2_correct)
                .setMessageIncorrect(R.string.quiz3_2_incorrect)
        );
        mQuestions.add(new Question(this)
                .setImage(R.drawable.quiz3_3)
                .setTypeString(R.string.quiz3_3, new int[]{R.string.quiz3_3_a1, R.string.quiz3_3_a2, R.string.quiz3_3_a3, R.string.quiz3_3_a4, R.string.quiz3_3_a5, R.string.quiz3_3_a6, R.string.quiz3_3_a7, R.string.quiz3_3_a8, R.string.quiz3_3_a9, R.string.quiz3_3_a10, R.string.quiz3_3_a11, R.string.quiz3_3_a12, R.string.quiz3_3_a13, R.string.quiz3_3_a14, R.string.quiz3_3_a15, R.string.quiz3_3_a16, R.string.quiz3_3_a17, R.string.quiz3_3_a18, R.string.quiz3_3_a19, R.string.quiz3_3_a20, R.string.quiz3_3_a21, R.string.quiz3_3_a22, R.string.quiz3_3_a23, R.string.quiz3_3_a24, R.string.quiz3_3_a25, R.string.quiz3_3_a26, R.string.quiz3_3_a27, R.string.quiz3_3_a28, R.string.quiz3_3_a29, R.string.quiz3_3_a30, R.string.quiz3_3_a31, R.string.quiz3_3_a32, R.string.quiz3_3_a33, R.string.quiz3_3_a34, R.string.quiz3_3_a35, R.string.quiz3_3_a36, R.string.quiz3_3_a37, R.string.quiz3_3_a38, R.string.quiz3_3_a39, R.string.quiz3_3_a40, R.string.quiz3_3_a41, R.string.quiz3_3_a42, R.string.quiz3_3_a43, R.string.quiz3_3_a44, R.string.quiz3_3_a45, R.string.quiz3_3_a46, R.string.quiz3_3_a47, R.string.quiz3_3_a48, R.string.quiz3_3_a49, R.string.quiz3_3_a50})
                .setMessageCorrect(R.string.quiz3_3_correct)
                .setMessageIncorrect(R.string.quiz3_3_incorrect)
        );
    }
